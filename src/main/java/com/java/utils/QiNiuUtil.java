...
public class QiNiuUtil {
    ...
    static String ACCESS_KEY = "sRb3n3CGc0zS1UScXcUBv__iMJPcof7u58hsRu8Y";
    static String SECRET_KEY = "bw2aA27wYwZVcjxZtUadRtcUih0v_2J_OrvP6wSU";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）
    static String bucketname = "hotel-mag"; //必须改
    //访问此空间的域名（必须去官网去查看外链）
    static String yName = "http://q6x2600wy.bkt.clouddn.com";
    //密钥配置
    ...
    public static Map<String,Object> fileUpload(MultipartFile myFile) throws IOException {
        ...
        //我们项目中上传文件是直接 获取整个源文件，而不是源文件的绝对路径
        try {
            //调用put方法上传
